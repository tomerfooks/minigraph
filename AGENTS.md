...
## Repository layout beyond the library
...
- `docs/pack/` — the positioning pack: architecture, code review, features,
  alternatives, competitive advantages, target audience, strategy, use cases.
  Numbers in there (LOC, stars) are dated; re-measure before quoting.
- `docs/screenshots/` — site screenshots, regenerated by hand.
